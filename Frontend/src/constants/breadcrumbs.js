...
export const BREADCRUMB_LABELS = {
  ...
  [GUIDE_AVION_FLIGHT_BOOKING_PATH]: 'Avion Flight Booking',
  [GUIDE_AVION_REDEMPTION_CHART_PATH]: 'Avion Redemption Chart',
  [GUIDE_AVION_POINTS_VALUE_PATH]: 'Avion Points Value',
  [GUIDE_AVION_TRANSFER_PARTNERS_PATH]: 'Avion Transfer Partners',
  [TOOL_AVION_POINTS_CALCULATOR_PATH]: 'Points Calculator',
  [SERVICE_FEES_PATH]: 'Service Fees',
  [HOW_IT_WORKS_PATH]: 'How It Works',
  [INDEPENDENT_SERVICE_DISCLOSURE_PATH]: 'Service Disclosure',
  [BLOG_PATH]: 'Blog',
...
export const BREADCRUMB_TRAILS = {
  ...
  [GUIDE_AVION_FLIGHT_BOOKING_PATH]: [HOME, GUIDES, crumb(GUIDE_AVION_FLIGHT_BOOKING_PATH)],
  [GUIDE_AVION_REDEMPTION_CHART_PATH]: [HOME, GUIDES, crumb(GUIDE_AVION_REDEMPTION_CHART_PATH)],
  [GUIDE_AVION_POINTS_VALUE_PATH]: [HOME, GUIDES, crumb(GUIDE_AVION_POINTS_VALUE_PATH)],
  [GUIDE_AVION_TRANSFER_PARTNERS_PATH]: [HOME, GUIDES, crumb(GUIDE_AVION_TRANSFER_PARTNERS_PATH)],
  [TOOL_AVION_POINTS_CALCULATOR_PATH]: [HOME, crumb(TOOL_AVION_POINTS_CALCULATOR_PATH)],
  [SERVICE_FEES_PATH]: [HOME, crumb(SERVICE_FEES_PATH)],
  [HOW_IT_WORKS_PATH]: [HOME, crumb(HOW_IT_WORKS_PATH)],
  [INDEPENDENT_SERVICE_DISCLOSURE_PATH]: [HOME, crumb(INDEPENDENT_SERVICE_DISCLOSURE_PATH)],
  [BLOG_PATH]: [HOME, BLOG],
